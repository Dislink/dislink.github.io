...
(function(w) {
    ...
    w.shareText = function(score) {
        ...
        if (score <= 99) return '山本仙人觉得不太够';
        if (score <= 149) return '山本对你刮目相看';
        if (score <= 199) return '仙人：我谢谢你';
        return '仙人本人？';
    }
    ...
    w.initSetting = function() {
        ...
        document.getElementsByTagName("title")[0].innerText = cookie("title") ? cookie("title") : "吃掉仙人";
        if (cookie("keyboard")) {
